...
(function ($) {
    ...
    Drupal.behaviors.novoProgram = {
        attach: function (context) {
            ...
            $(".field-name-field-program-kids-list table.field-multiple-table thead tr th:eq(3)", context).append('<span class="novo-program-kid-data-header"><span class="novo-program-kid-data-header-age">Age</span> <span class="novo-program-kid-data-header-grade">Grade</span></span>');
