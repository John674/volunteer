...
(function ($) {
    ...
    Drupal.behaviors.novoProgram = {
        attach: function (context) {
            ...
            // Add labels.
            $(".field-name-field-program-kids-list table.field-multiple-table thead tr th:eq(4)", context).append('<span class="novo-program-kid-data-header"><span class="novo-program-kid-data-header-age">Age</span> <span class="novo-program-kid-data-header-grade">Grade</span></span>');
            $(".field-name-field-program-kids-list table.sticky-header thead tr th:eq(4)", context).append('<span class="novo-program-kid-data-header"><span class="novo-program-kid-data-header-age">Age</span> <span class="novo-program-kid-data-header-grade">Grade</span></span>');
